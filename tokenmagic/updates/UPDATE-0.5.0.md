...
*New filter :*
- Sprite filter (beta) : to add sprites and manipulate them (color, translation, rotation, etc.)
...
- New automatically hide template effects setting that shows non-essential template.
