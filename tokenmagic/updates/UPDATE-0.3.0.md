...
- Template support with an updated user interface.
    ...
    - Slider to change opacity of the inner texture or/and FX.
...
*New FX :*
- Spider-Web filter
    - Specifically designed for templates (but usable on tokens, tiles and drawings)
- XFog filter
    - A thick and shifting fog, also designed for templates.
