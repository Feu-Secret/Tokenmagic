 ...
 */ var __filters = (function (n, o, H, b) {
  "use strict";
  ...
  class h extends o.Filter {
    constructor(e = 4, r = 3, i = !1) {
      super(re, i ? oe : ie),
        ...
        (this._pixelSize = new o.Point()),
        (this.pixelSize = 1),
        (this._clamp = i),
        Array.isArray(e) ? (this.kernels = e) : ((this._blur = e), (this.quality = r));
    }
    apply(e, r, i, s) {
      const a = this._pixelSize.x / r._frame.width,
        l = this._pixelSize.y / r._frame.height;
      let u;
      if (this._quality === 1 || this._blur === 0)
        (u = this._kernels[0] + 0.5),
          (this.uniforms.uOffset[0] = u * a),
          (this.uniforms.uOffset[1] = u * l),
          e.applyFilter(this, r, i, s);
      else {
        const c = e.getFilterTexture();
        let d = r,
          m = c,
          g;
        const Q = this._quality - 1;
        for (let _ = 0; _ < Q; _++)
          (u = this._kernels[_] + 0.5),
            (this.uniforms.uOffset[0] = u * a),
            (this.uniforms.uOffset[1] = u * l),
            e.applyFilter(this, d, m, 1),
            (g = d),
            (d = m),
            (m = g);
        (u = this._kernels[Q] + 0.5),
          (this.uniforms.uOffset[0] = u * a),
          (this.uniforms.uOffset[1] = u * l),
          e.applyFilter(this, d, i, s),
          e.returnFilterTexture(c);
      }
    }
    _updatePadding() {
    ...
    _generateKernels() {
      ...
      if (e > 0) {
        let s = e;
        const a = e / r;
        for (let l = 1; l < r; l++) (s -= a), i.push(s);
      }
...
`;
  class ae extends o.Filter {
    constructor(e = 0.5) {
      super(S, se), (this.threshold = e);
    }
    get threshold() {
  ...
  var le = `uniform sampler2D uSampler;
varying vec2 vTextureCoord;
...
`;
  const T = class extends o.Filter {
    constructor(t) {
      super(S, le),
        (this.bloomScale = 1),
        (this.brightness = 1),
        (this._resolution = o.settings.FILTER_RESOLUTION),
        typeof t == "number" && (t = { threshold: t });
      const e = Object.assign(T.defaults, t);
      (this.bloomScale = e.bloomScale), (this.brightness = e.brightness);
      const { kernels: r, blur: i, quality: s, pixelSize: a, resolution: l } = e;
      (this._extractFilter = new ae(e.threshold)),
        (this._extractFilter.resolution = l),
        (this._blurFilter = r ? new h(r) : new h(i, s)),
        (this.pixelSize = a),
        (this.resolution = l);
    }
    apply(t, e, r, i, s) {
      const a = t.getFilterTexture();
      this._extractFilter.apply(t, e, a, 1, s);
      const l = t.getFilterTexture();
      this._blurFilter.apply(t, a, l, 1),
        (this.uniforms.bloomScale = this.bloomScale),
        (this.uniforms.brightness = this.brightness),
        (this.uniforms.bloomTexture = l),
        t.applyFilter(this, e, r, i),
        t.returnFilterTexture(l),
  ...
  F.defaults = {
    ...
    quality: 4,
    pixelSize: 1,
    resolution: o.settings.FILTER_RESOLUTION,
  };
...
`;
  class ce extends o.Filter {
    constructor(e = 8) {
      super(ne, ue), (this.size = e);
    }
    get size() {
  ...
  var fe = `attribute vec2 aVertexPosition;
attribute vec2 aTextureCoord;
...
`;
  class he extends o.Filter {
    ...
    get rotation() {
      return this._angle / o.DEG_TO_RAD;
    }
    set rotation(e) {
      (this._angle = e * o.DEG_TO_RAD), this._updateTransform();
    }
    get thickness() {
    ...
    get lightColor() {
      return o.utils.rgb2hex(this.uniforms.lightColor);
    }
    set lightColor(e) {
      o.utils.hex2rgb(e, this.uniforms.lightColor);
    }
    get lightAlpha() {
    ...
    get shadowColor() {
      return o.utils.rgb2hex(this.uniforms.shadowColor);
    }
    set shadowColor(e) {
      o.utils.hex2rgb(e, this.uniforms.shadowColor);
    }
    get shadowAlpha() {
  ...
  class me extends o.Filter {
    constructor(e = 2, r = 4, i = o.settings.FILTER_RESOLUTION, s = 5) {
      super();
      let a, l;
      typeof e == "number"
        ? ((a = e), (l = e))
        : e instanceof o.Point
        ? ((a = e.x), (l = e.y))
        : Array.isArray(e) && ((a = e[0]), (l = e[1])),
        (this.blurXFilter = new b.BlurFilterPass(!0, a, r, i, s)),
        (this.blurYFilter = new b.BlurFilterPass(!1, l, r, i, s)),
        (this.blurYFilter.blendMode = o.BLEND_MODES.SCREEN),
        (this.defaultFilter = new H.AlphaFilter());
    }
    apply(e, r, i, s) {
      const a = e.getFilterTexture();
      this.defaultFilter.apply(e, r, i, s),
        this.blurXFilter.apply(e, r, a, 1),
        this.blurYFilter.apply(e, a, i, 0),
...
`;
  const z = class extends o.Filter {
    constructor(t) {
      super(ve, ge), (this.uniforms.dimensions = new Float32Array(2)), Object.assign(this, z.defaults, t);
    }
    apply(t, e, r, i) {
      const { width: s, height: a } = e.filterFrame;
      (this.uniforms.dimensions[0] = s), (this.uniforms.dimensions[1] = a), t.applyFilter(this, e, r, i);
    }
    get radius() {
  ...
  let A = z;
  A.defaults = { center: [0.5, 0.5], radius: 100, strength: 1 };
...
void main() {
  ...
  class ye extends o.Filter {
    ...
    apply(e, r, i, s) {
      (this.uniforms._mix = this.mix), e.applyFilter(this, r, i, s);
    }
    get colorSize() {
      return this._size;
    }
    ...
    set colorMap(e) {
      !e ||
        (e instanceof o.Texture || (e = o.Texture.from(e)),
        e != null &&
          e.baseTexture &&
          ((e.baseTexture.scaleMode = this._scaleMode),
          (e.baseTexture.mipmap = o.MIPMAP_MODES.OFF),
          (this._size = e.height),
    ...
    set nearest(e) {
      (this._nearest = e), (this._scaleMode = e ? o.SCALE_MODES.NEAREST : o.SCALE_MODES.LINEAR);
      const r = this._colorMap;
      r &&
        r.baseTexture &&
        ((r.baseTexture._glTextures = {}),
        (r.baseTexture.scaleMode = this._scaleMode),
        (r.baseTexture.mipmap = o.MIPMAP_MODES.OFF),
        r._updateID++,
...
`;
  class be extends o.Filter {
    ...
    set color(e) {
      ...
      typeof e == "number"
        ? (o.utils.hex2rgb(e, r), (this._color = e))
        : ((r[0] = e[0]), (r[1] = e[1]), (r[2] = e[2]), (this._color = o.utils.rgb2hex(r)));
    }
    get color() {
      return this._color;
    }
...
`;
  class Fe extends o.Filter {
    ...
    set originalColor(e) {
      ...
      typeof e == "number"
        ? (o.utils.hex2rgb(e, r), (this._originalColor = e))
        : ((r[0] = e[0]), (r[1] = e[1]), (r[2] = e[2]), (this._originalColor = o.utils.rgb2hex(r)));
    }
    get originalColor() {
    ...
    set newColor(e) {
      ...
      typeof e == "number"
        ? (o.utils.hex2rgb(e, r), (this._newColor = e))
        : ((r[0] = e[0]), (r[1] = e[1]), (r[2] = e[2]), (this._newColor = o.utils.rgb2hex(r)));
    }
    get newColor() {
  ...
  var ze = `attribute vec2 aVertexPosition;
attribute vec2 aTextureCoord;
...
`;
  const P = class extends o.Filter {
    constructor(t) {
      super(Oe, Re),
        (this.time = 0),
        (this.seed = 0),
        (this.uniforms.dimensions = new Float32Array(2)),
        Object.assign(this, P.defaults, t);
    }
    apply(t, e, r, i) {
      const { width: s, height: a } = e.filterFrame;
...
`;
  class ke extends o.Filter {
    constructor(e = 1, r = 5, i = !0) {
      super($e, Ee), (this.scale = e), (this.angle = r), (this.grayscale = i);
    }
    get scale() {
  ...
  var je = `attribute vec2 aVertexPosition;
attribute vec2 aTextureCoord;
...
void main(void){
    ...
    D = (t, e, r) => (e in t ? Ie(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (t[e] = r)),
    O = (t, e) => {
      for (var r in e || (e = {})) Ve.call(e, r) && D(t, r, e[r]);
      if (M) for (var r of M(e)) Ne.call(e, r) && D(t, r, e[r]);
      return t;
    };
  const x = class extends o.Filter {
    constructor(t) {
      super(), (this.angle = 45), (this._distance = 5), (this._resolution = o.settings.FILTER_RESOLUTION);
      const e = t ? O(O({}, x.defaults), t) : x.defaults,
        { kernels: r, blur: i, quality: s, pixelSize: a, resolution: l } = e;
      (this._tintFilter = new o.Filter(je, Le)),
        (this._tintFilter.uniforms.color = new Float32Array(4)),
        (this._tintFilter.uniforms.shift = new o.Point()),
        (this._tintFilter.resolution = l),
        (this._blurFilter = r ? new h(r) : new h(i, s)),
        (this.pixelSize = a),
        (this.resolution = l);
      const { shadowOnly: u, rotation: c, distance: d, alpha: m, color: g } = e;
      (this.shadowOnly = u),
        (this.rotation = c),
        (this.distance = d),
        (this.alpha = m),
    ...
    apply(t, e, r, i) {
      ...
      this._tintFilter.apply(t, e, s, 1),
    ...
    set distance(t) {
      (this._distance = t), this._updatePadding(), this._updateShift();
    }
    get rotation() {
      return this.angle / o.DEG_TO_RAD;
    }
    set rotation(t) {
      (this.angle = t * o.DEG_TO_RAD), this._updateShift();
    }
    get alpha() {
    ...
    get color() {
      return o.utils.rgb2hex(this._tintFilter.uniforms.color);
    }
    set color(t) {
      o.utils.hex2rgb(t, this._tintFilter.uniforms.color);
    }
    get kernels() {
      return this._blurFilter.kernels;
    }
  ...
  var Be = `attribute vec2 aVertexPosition;
attribute vec2 aTextureCoord;
...
`;
  class Ge extends o.Filter {
    constructor(e = 5) {
      super(Be, Xe), (this.strength = e);
    }
    get strength() {
      return this.uniforms.strength;
    }
  ...
  const p = class extends o.Filter {
    constructor(t) {
      super(qe, Ke),
        ...
        (this.texture = o.Texture.from(this._canvas, { scaleMode: o.SCALE_MODES.NEAREST })),
        Object.assign(this, p.defaults, t);
    }
    apply(t, e, r, i) {
      const { width: s, height: a } = e.filterFrame;
    ...
    _randomizeSizes() {
      ...
      if (this.average) {
        ...
        for (let l = 0; l < e; l++) {
          const u = a / (s - l),
            c = Math.max(u * (1 - Math.random() * 0.6), i);
          (t[l] = c), (a -= c);
        }
        t[e] = a;
      } else {
        ...
        for (let l = 0; l < e; l++) {
          const u = Math.max(a * s * Math.random(), i);
          (t[l] = u), (s -= u);
        }
        t[e] = s;
      }
    ...
    _randomizeOffsets() {
      for (let t = 0; t < this._slices; t++) this._offsets[t] = Math.random() * (Math.random() < 0.5 ? -1 : 1);
    }
    refresh() {
    ...
    redraw() {
      ...
      for (let a = 0; a < this._slices; a++) {
        i = Math.floor(this._offsets[a] * 256);
        const l = this._sizes[a] * t,
          u = i > 0 ? i : 0,
          c = i < 0 ? -i : 0;
        (r.fillStyle = `rgba(${u}, ${c}, 0, 1)`), r.fillRect(0, s >> 0, t, (l + 1) >> 0), (s += l);
      }
...
`;
  const $ = class extends o.Filter {
    constructor(t) {
      const e = Object.assign({}, $.defaults, t),
        { outerStrength: r, innerStrength: i, color: s, knockout: a, quality: l, alpha: u } = e,
        c = Math.round(e.distance);
      super(
        We,
        Ye.replace(/__ANGLE_STEP_SIZE__/gi, `${(1 / l / c).toFixed(7)}`).replace(/__DIST__/gi, `${c.toFixed(0)}.0`)
      ),
        (this.uniforms.glowColor = new Float32Array([0, 0, 0, 1])),
        (this.uniforms.alpha = 1),
        Object.assign(this, { color: s, outerStrength: r, innerStrength: i, padding: c, knockout: a, alpha: u });
    }
    get color() {
      return o.utils.rgb2hex(this.uniforms.glowColor);
    }
    set color(t) {
      o.utils.hex2rgb(t, this.uniforms.glowColor);
    }
    get outerStrength() {
...
`;
  const k = class extends o.Filter {
    constructor(t) {
      super(Ze, Qe.replace("${perlin}", Ue)),
        (this.parallel = !0),
        (this.time = 0),
        (this._angle = 0),
        (this.uniforms.dimensions = new Float32Array(2));
      const e = Object.assign(k.defaults, t);
      (this._angleLight = new o.Point()),
        (this.angle = e.angle),
        (this.gain = e.gain),
  ...
  let j = k;
  j.defaults = { angle: 30, gain: 0.5, lacunarity: 2.5, time: 0, parallel: !0, center: [0, 0], alpha: 1 };
  var He = `attribute vec2 aVertexPosition;
attribute vec2 aTextureCoord;
...
`;
  class it extends o.Filter {
    constructor(e = [0, 0], r = 5, i = 0) {
      super(tt, rt),
        (this.kernelSize = 5),
        (this.uniforms.uVelocity = new Float32Array(2)),
        (this._velocity = new o.ObservablePoint(this.velocityChanged, this)),
        this.setVelocity(e),
        (this.kernelSize = r),
        (this.offset = i);
    }
    apply(e, r, i, s) {
      const { x: a, y: l } = this.velocity;
      (this.uniforms.uKernelSize = a !== 0 || l !== 0 ? this.kernelSize : 0), e.applyFilter(this, r, i, s);
    }
    set velocity(e) {
      this.setVelocity(e);
    }
...
`;
  class at extends o.Filter {
    constructor(e, r = 0.05, i = e.length) {
      super(ot, st.replace(/%maxColors%/g, i.toFixed(0))),
        (this._replacements = []),
        (this._maxColors = 0),
        (this.epsilon = r),
        (this._maxColors = i),
    ...
    set replacements(e) {
      const r = this.uniforms.originalColors,
        ...
        s = e.length;
      if (s > this._maxColors)
        throw new Error(`Length of replacements (${s}) exceeds the maximum colors length (${this._maxColors})`);
      r[s * 3] = -1;
      for (let a = 0; a < s; a++) {
        const l = e[a];
        let u = l[0];
        typeof u == "number" ? (u = o.utils.hex2rgb(u)) : (l[0] = o.utils.rgb2hex(u)),
          (r[a * 3] = u[0]),
          (r[a * 3 + 1] = u[1]),
          (r[a * 3 + 2] = u[2]);
        let c = l[1];
        typeof c == "number" ? (c = o.utils.hex2rgb(c)) : (l[1] = o.utils.rgb2hex(c)),
          (i[a * 3] = c[0]),
          (i[a * 3 + 1] = c[1]),
          (i[a * 3 + 2] = c[2]);
      }
...
`;
  const L = class extends o.Filter {
    constructor(t, e = 0) {
      super(lt, nt),
        (this.seed = 0),
        (this.uniforms.dimensions = new Float32Array(2)),
        typeof t == "number" ? ((this.seed = t), (t = void 0)) : (this.seed = e),
        Object.assign(this, L.defaults, t);
    }
    apply(t, e, r, i) {
      var s, a;
      (this.uniforms.dimensions[0] = (s = e.filterFrame) == null ? void 0 : s.width),
        (this.uniforms.dimensions[1] = (a = e.filterFrame) == null ? void 0 : a.height),
        (this.uniforms.seed = this.seed),
        t.applyFilter(this, e, r, i);
    }
    set sepia(t) {
...
`;
  const v = class extends o.Filter {
    constructor(t = 1, e = 0, r = 0.1, i = 1) {
      super(ut, ct.replace(/\$\{angleStep\}/, v.getAngleStep(r))),
        (this._thickness = 1),
        (this._alpha = 1),
        (this.uniforms.thickness = new Float32Array([0, 0])),
        (this.uniforms.outlineColor = new Float32Array([0, 0, 0, 1])),
        (this.uniforms.alpha = i),
        Object.assign(this, { thickness: t, color: e, quality: r, alpha: i });
    }
    static getAngleStep(t) {
      const e = Math.max(t * v.MAX_SAMPLES, v.MIN_SAMPLES);
      return ((Math.PI * 2) / e).toFixed(7);
    }
    apply(t, e, r, i) {
      (this.uniforms.thickness[0] = this._thickness / e._frame.width),
        (this.uniforms.thickness[1] = this._thickness / e._frame.height),
    ...
    get color() {
      return o.utils.rgb2hex(this.uniforms.outlineColor);
    }
    set color(t) {
      o.utils.hex2rgb(t, this.uniforms.outlineColor);
    }
    get thickness() {
      return this._thickness;
    }
  ...
  let y = v;
  (y.MIN_SAMPLES = 1), (y.MAX_SAMPLES = 100);
...
`;
  class ht extends o.Filter {
    constructor(e = 10) {
      super(ft, dt), (this.size = e);
    }
    get size() {
  ...
  var mt = `attribute vec2 aVertexPosition;
attribute vec2 aTextureCoord;
...
`;
  class gt extends o.Filter {
    constructor(e = 0, r = [0, 0], i = 5, s = -1) {
      super(mt, vt), (this._angle = 0), (this.angle = e), (this.center = r), (this.kernelSize = i), (this.radius = s);
    }
    apply(e, r, i, s) {
      (this.uniforms.uKernelSize = this._angle !== 0 ? this.kernelSize : 0), e.applyFilter(this, r, i, s);
    }
    set angle(e) {
...
`;
  class _t extends o.Filter {
    constructor(e = [-10, 0], r = [0, 10], i = [0, 0]) {
      super(yt, Ct), (this.red = e), (this.green = r), (this.blue = i);
    }
    get red() {
      return this.uniforms.red;
    }
  ...
  var bt = `attribute vec2 aVertexPosition;
attribute vec2 aTextureCoord;
...
`;
  const B = class extends o.Filter {
    constructor(t = [0, 0], e, r = 0) {
      super(bt, St), (this.center = t), Object.assign(this, B.defaults, e), (this.time = r);
    }
    apply(t, e, r, i) {
  ...
  let X = B;
  X.defaults = { amplitude: 30, wavelength: 160, brightness: 1, speed: 500, radius: -1 };
  var Tt = `attribute vec2 aVertexPosition;
attribute vec2 aTextureCoord;
...
`;
  class zt extends o.Filter {
    ...
    apply(e, r, i, s) {
      var a, l;
      (this.uniforms.dimensions[0] = (a = r.filterFrame) == null ? void 0 : a.width),
        (this.uniforms.dimensions[1] = (l = r.filterFrame) == null ? void 0 : l.height),
        e.applyFilter(this, r, i, s);
    }
    get texture() {
    ...
    set color(e) {
      ...
      typeof e == "number"
        ? (o.utils.hex2rgb(e, r), (this._color = e))
        : ((r[0] = e[0]), (r[1] = e[1]), (r[2] = e[2]), (r[3] = e[3]), (this._color = o.utils.rgb2hex(r)));
    }
    get color() {
      return this._color;
    }
...
`;
  class C extends o.Filter {
    constructor(e = 100, r = 600, i, s) {
      super(At, Pt),
        (this.uniforms.blur = e),
        (this.uniforms.gradientBlur = r),
        (this.uniforms.start = i || new o.Point(0, window.innerHeight / 2)),
        (this.uniforms.end = s || new o.Point(600, window.innerHeight / 2)),
        (this.uniforms.delta = new o.Point(30, 30)),
        (this.uniforms.texSize = new o.Point(window.innerWidth, window.innerHeight)),
        this.updateDelta();
    }
    updateDelta() {
  ...
  class wt extends o.Filter {
    constructor(e = 100, r = 600, i, s) {
      super(), (this.tiltShiftXFilter = new G(e, r, i, s)), (this.tiltShiftYFilter = new q(e, r, i, s));
    }
    apply(e, r, i, s) {
      const a = e.getFilterTexture();
      this.tiltShiftXFilter.apply(e, r, a, 1), this.tiltShiftYFilter.apply(e, a, i, s), e.returnFilterTexture(a);
    }
    get blur() {
...
`;
  const K = class extends o.Filter {
    constructor(t) {
      super(Mt, Dt), Object.assign(this, K.defaults, t);
    }
    get offset() {
  ...
  let W = K;
  W.defaults = { radius: 200, angle: 4, padding: 20, offset: new o.Point() };
  var Ot = `attribute vec2 aVertexPosition;
attribute vec2 aTextureCoord;
...
`,
    ...
    kt = (t, e) => {
      var r = {};
      for (var i in t) $t.call(t, i) && e.indexOf(i) < 0 && (r[i] = t[i]);
      if (t != null && Y) for (var i of Y(t)) e.indexOf(i) < 0 && Et.call(t, i) && (r[i] = t[i]);
      return r;
    };
  const Z = class extends o.Filter {
    constructor(t) {
      const e = Object.assign(Z.defaults, t),
        { maxKernelSize: r } = e,
        i = kt(e, ["maxKernelSize"]);
      super(Ot, Rt.replace("${maxKernelSize}", r.toFixed(1))), Object.assign(this, i);
    }
    get center() {
      return this.uniforms.uCenter;
    }
  ...
  let U = Z;
  return (
    (U.defaults = { strength: 0.1, center: [0, 0], innerRadius: 0, radius: -1, maxKernelSize: 32 }),
    (n.AdjustmentFilter = te),
    (n.AdvancedBloomFilter = F),
    (n.AsciiFilter = ce),
    (n.BevelFilter = he),
    (n.BloomFilter = me),
    (n.BulgePinchFilter = A),
    (n.CRTFilter = w),
    (n.ColorMapFilter = ye),
    (n.ColorOverlayFilter = be),
    (n.ColorReplaceFilter = Fe),
    (n.ConvolutionFilter = Pe),
    (n.CrossHatchFilter = De),
    (n.DotFilter = ke),
    (n.DropShadowFilter = R),
    (n.EmbossFilter = Ge),
    (n.GlitchFilter = f),
    (n.GlowFilter = E),
    (n.GodrayFilter = j),
    (n.GrayscaleFilter = et),
    (n.KawaseBlurFilter = h),
    (n.MotionBlurFilter = it),
    (n.MultiColorReplaceFilter = at),
    (n.OldFilmFilter = I),
    (n.OutlineFilter = y),
    (n.PixelateFilter = ht),
    (n.RGBSplitFilter = _t),
    (n.RadialBlurFilter = gt),
    (n.ReflectionFilter = N),
    (n.ShockwaveFilter = X),
    (n.SimpleLightmapFilter = zt),
    (n.TiltShiftAxisFilter = C),
    (n.TiltShiftFilter = wt),
    (n.TiltShiftXFilter = G),
    (n.TiltShiftYFilter = q),
    (n.TwistFilter = W),
    (n.ZoomBlurFilter = U),
